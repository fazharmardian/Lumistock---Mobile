...
class BookedDetail extends StatefulWidget {
  ...
  const BookedDetail({Key? key, required this.bookmark}) : super(key: key);
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      Image.network(
                        'http://lumistock.test/storage/${widget.bookmark.image}',
                        height: 400,
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              widget.bookmark.amount > 0
                                  ? "Available in stock"
                                  : "Not Available",
                              style: TextStyle(
                                  color: widget.bookmark.amount > 0
                                      ? Colors.indigo
                                      : Colors.red,
                                  fontSize: 16),
                            ),
                                    ...
                                    IconButton(
                                      ...
                                      onPressed: () {
                                        setState(() {
                                          ...
                                          if (quantity < widget.bookmark.amount)
                                            quantity++;
                                        });
                                      },
                                    ),
